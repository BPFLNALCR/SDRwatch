...
class Sweeper:
    ...
    def _sweep_params(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "role_lane": getattr(args, "role_lane", None),
            "source_task": getattr(args, "source_task", None),
            "device_identity": getattr(args, "device_identity", None),
            "device_serial": getattr(args, "device_serial", None),
            "device_index": getattr(args, "device_index", None),
            "identity_confidence": getattr(args, "identity_confidence", None),
            "active_device_count": getattr(args, "active_device_count", None),
            "active_role_count": getattr(args, "active_role_count", None),
            ...
            "revisit_max_bands": getattr(args, "revisit_max_bands", None),
            "revisit_floor_threshold_db": getattr(args, "revisit_floor_threshold_db", None),
