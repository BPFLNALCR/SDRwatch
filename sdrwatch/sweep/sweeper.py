...
def _track_spur_hits(tracker: Dict[int, Dict[str, float]], segments: List[Segment]) -> None:
    for seg in segments:
...
def _persist_spur_calibration(store: Store, tracker: Dict[int, Dict[str, float]], total_windows: int, min_ratio: float = 0.6) -> None:
