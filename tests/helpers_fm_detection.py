...
def narrow_args(**overrides: Any) -> SimpleNamespace:
    values: dict[str, Any] = {
        ...
        "min_identity_bandwidth_hz": None,
        "min_persist_bandwidth_hz": None,
        "max_persist_bandwidth_hz": None,
        "display_bandwidth_pad_hz": None,
        "min_display_bandwidth_hz": None,
        "allow_revisit_to_shrink_identity": None,
        "allow_revisit_to_move_center": None,
        "min_revisit_bandwidth_for_identity_update_hz": None,
        "max_revisit_center_delta_for_identity_update_hz": None,
        "fragmented_revisit_policy": None,
        "raw_fragment_interpretation": None,
        "center_smoothing_enabled": None,
